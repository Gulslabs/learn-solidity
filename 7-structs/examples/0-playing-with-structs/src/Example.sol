...
contract Example {
    ...
    function payment(uint256 key) external payable {
      // only if you put in storage will the chagnes be applied to order array; otherwise a modification to memory is lost once you get outside the function. 
      // with memory test-case will fail. look like 44 for the fix. 
